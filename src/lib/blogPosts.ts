...
const allBlogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      "![Google SERP for the query weddings.io showing Weddings.io ranking as the official multicultural wedding platform established May 13, 2015, alongside a variant AIWeddings listing](/blog-images/entity-authority-serp-1.png \"Live Google SERP for 'weddings.io' — the verified entity (Weddings.io™, est. May 13, 2015) sits alongside a variant domain. Same query, two very different entity signatures.\")",
      ...
      "![Google AI Overview panel describing the wedding platform, with the citation link resolving to Weddings.io as the canonical entity](/blog-images/entity-authority-serp-2.png \"Google's AI Overview conflates the variant into the summary text, but the citation link — the trust anchor — resolves to Weddings.io. That's information stripping in action: the AI credits the entity, not the wrapper.\")",
