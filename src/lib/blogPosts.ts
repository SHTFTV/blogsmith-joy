...
const allBlogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      "**Start with the ecosystem question.** Which platform covers the most of your planning needs in one place? A tool that handles your wedding website, guest RSVPs, registry, vendor tracking, and [budget](https://weddings.io/checklist) in one place will cause you less friction than four tools that each do one piece well but do not talk to each other.",
      "**Consider where your vendors already are.** If the florists, photographers, and venues you are considering use a particular platform for their contracts and payments, being on the same platform creates a smoother experience for everyone. The Knot's marketplace reaches more vendors than any other platform — which means the vendors you want to work with are more likely to be actively managing their presence there.",
      "**Evaluate the review depth.** Reviews are your primary tool for evaluating vendors. More reviews, from more weddings, over more years, give you a more reliable signal. Platforms with deep review histories are more useful than those with newer, thinner review databases regardless of how sophisticated their AI summarization is.",
      "**Do not over-optimize for AI features.** Every platform has AI features now. The question is not which one has the most impressive AI demo — it is which one has the most useful experience for your specific planning situation.",
      ...
      "**What is the track record on pricing?** HoneyBook raised prices by 51 to 89% in February 2025. That kind of shift is painful for vendors who have built their business around a specific cost structure. Look at the funding history, the pricing trajectory, and the business model of any platform you are considering — and think about what happens to your subscription cost if the company needs to improve its unit economics.",
      "**Who owns the customer relationship — you or the platform?** Some platforms are designed to be the interface between you and your clients. Others put the vendor-client relationship at the center and use the platform as infrastructure. The difference matters for your long-term positioning and your ability to maintain client relationships if you ever change platforms.",
