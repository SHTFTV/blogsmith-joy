...
const allBlogPosts: BlogPost[] = [
  {
    ...
    image: "/opengraph.jpg",
    imageAlt: "Data dashboard hero for India Wedding Market Data 2026 showing $130 billion market size, 21.87% destination wedding CAGR, 1,544 active wedding tech companies, $70M collective funding, and ₹39.5 lakh average wedding budget on WedMeGood.",
    readTime: "14 min",
    ...
    body: [
      ...
      "→ [The Real Cost of Building a Wedding Platform in India](/blog/cost-of-building-a-wedding-platform-india-2026/)",
      "→ [Meragi vs The Wedding Company: Two Different Bets](/blog/meragi-vs-wedding-company-india-2026/)",
      "→ [Does a Wedding App Need $2M to Build Brand Trust?](/blog/wedding-app-india-funding-brand-trust/)",
      "## Market Size",
  ...
  },
  {
    ...
    image: "/opengraph.jpg",
    imageAlt: "Editorial split comparison image contrasting Meragi's premium 3D-visualisation design bet with The Wedding Company's contractual-accountability scale bet across India's wedding fulfilment market.",
    readTime: "12 min",
