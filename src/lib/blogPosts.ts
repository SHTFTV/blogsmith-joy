...
const allBlogPosts: BlogPost[] = [
  {
    ...
    seoTitle: "AI Weddings: Level 1 vs Level 2 — How to Actually Use AI Wedding Tools | Weddings.io",
    metaDescription: "Most couples and wedding vendors use AI weddings tools at Level 1 (drafting). The ones getting 473 hours back per year moved to Level 2 (infrastructure). Here's the difference — and how to make the shift.",
    focusKeywords: [
      "AI weddings",
      "AI wedding planning",
      "AI wedding tools",
    ...
    body: [
      ...
      "Level 2 for couples looks different. It is a planning platform that knows where you are in the process and surfaces the right tasks at the right time. It is a tool that keeps all your vendor contacts, contracts, timelines, and budget in one place — so you are not cross-referencing four apps to find whether the florist has confirmed the delivery time. It is an AI-powered checklist that adjusts dynamically as your wedding date approaches, rather than a static spreadsheet that goes stale the moment something changes.",
