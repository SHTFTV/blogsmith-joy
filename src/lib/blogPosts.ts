...
const allBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "7 min",
    excerpt: "Both paths have worked — invented names and category addresses. The question is which one fits what you are building, and what compounds around it after the domain is acquired.",
    seoTitle: "Does Your Startup Need a Category Domain? A Founder's Framework",
    metaDescription: "Great brands have been built on invented names. An honest founder's framework on when a category domain compounds — and what to build around it after.",
    focusKeywords: [
      "category domain",
