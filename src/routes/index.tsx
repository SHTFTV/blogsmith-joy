...
const addOns = [
  ["Creators", "Outstanding Business Page", "$10", "/ month per 100K pop", "Exclusive SEO Marketing Page for creators and standout businesses. Population-based pricing, clean $10 increments. Apply only if the business is genuinely strong — we are picky.", "Apply — We Are Picky", "https://industryarmymarketing.com/seo"],
