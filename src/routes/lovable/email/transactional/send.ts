  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Only admins may invoke the templated-email relay directly, otherwise
        // any authenticated user could send templated emails to arbitrary
        // recipients via the verified sending domain.
